...
const SERVICES: ServiceSeed[] = [
  {
    ...
    description:
      'Criamos sites institucionais sob medida, com design único, performance de ponta e otimização para os mecanismos de busca. Sua empresa com uma presença digital à altura do seu posicionamento.',
    features: [
      {
        icon: 'lucide:palette',
  ...
  },
  {
    ...
    description:
      'Landing pages de alta conversão com copy persuasivo, design otimizado e integração com suas ferramentas de marketing (Meta Ads, Google Ads, CRM).',
    features: [
      {
        icon: 'lucide:zap',
  ...
  },
  {
    ...
    description:
      'Desenvolvemos e-commerces robustos em Shopify, VTEX, WooCommerce ou headless com Next.js, sempre pensando em conversão e experiência do cliente.',
    features: [
      {
  ...
  },
  {
    ...
    description:
      'Desenvolvemos SaaS B2B/B2C completos: autenticação, billing recorrente (Stripe), multi-tenant, painel admin e tudo que sua operação precisa.',
    features: [
      {
        icon: 'lucide:lock',
  ...
  },
  {
    ...
    description:
      'Blogs e portais com CMS amigável (Strapi, Sanity, WordPress headless), SEO técnico de ponta e estrutura preparada para escalar tráfego orgânico.',
    features: [
      {
        icon: 'lucide:edit-3',
        title: 'CMS amigável',
  ...
  },
  {
    ...
    description:
      'Plano mensal de manutenção: atualizações, backups, monitoramento 24/7, melhorias contínuas de performance e SEO. Você foca no negócio, a gente cuida do site.',
    features: [
      {
        icon: 'lucide:shield',
        title: 'Segurança',
...
type ProjectSeed = {
  ...
  client: string;
  year: number;
  category: 'site-institucional' | 'landing-page' | 'ecommerce' | 'saas' | 'blog' | 'app-web' | 'outro';
  shortDescription: string;
  description: string;
  liveUrl: string;
  technologies: string[];
...
const PROJECTS: ProjectSeed[] = [
  {
    ...
    description:
      'Desenvolvemos do zero a plataforma Aurora Finance: autenticação, multi-tenant, integração com Open Finance, dashboards em tempo real e billing recorrente via Stripe.',
  ...
  },
  {
    ...
    description:
      'Projeto focado em apresentar com sofisticação o portfólio do escritório. Layout editorial, fotografias em alta resolução, animações suaves e ótima performance.',
  ...
  },
  {
    ...
    description:
      'E-commerce headless conectando Shopify (catálogo/pagamentos) a um front-end Next.js para performance e SEO máximos. Clube de assinatura mensal e PIX integrados.',
  ...
  },
  {
    ...
    description:
      'Página de lançamento criada em parceria com a equipe de marketing da Helix. Foco em copy persuasivo, vídeo hero, prova social e CTAs claros.',
  ...
  },
  {
    ...
    description:
      'Migramos um WordPress legado para uma stack moderna (Next.js + Strapi), melhorando performance em 300% e dobrando o tráfego orgânico em 6 meses.',
  ...
  },
  {
    ...
    description:
      'PWA com modo offline, geolocalização em tempo real, integração com Google Maps e painel administrativo completo para a operação.',
