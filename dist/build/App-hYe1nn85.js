...
`,Zn=m(y)`
  flex: 1;
  min-width: 0;
`,Qn=({folder:e})=>{const{formatMessage:n}=D(),{navigateToFolder:r}=Ie(),o=s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),r(e))};return t.jsxs(Kn,{onClick:()=>r(e),onKeyDown:o,role:"listitem",tabIndex:0,children:[t.jsx(qn,{children:t.jsx(oe,{width:20,height:20})}),t.jsx(Zn,{textColor:"neutral800",ellipsis:!0,children:e.name}),t.jsx(se,{label:n({id:f("control-card.more-actions"),defaultMessage:"More actions"}),variant:"ghost",onClick:s=>s.stopPropagation(),children:t.jsx(ae,{})})]})},De=m(F)`
  position: relative;
  width: 100%;
  padding-bottom: 62.5%;
  height: 0;
